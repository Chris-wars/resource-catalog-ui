    ...
    if (error) {
        return (
            <ErrorMessage 
                ...
                hint="Bitte überprüfen Sie, ob das Backend unter `http://localhost:5002/` läuft, oder versuchen Sie es später erneut."                
            />
        );
    }
    ...
    if (resources.length === 0) {
        return (
            <ErrorMessage
                ...
                hint="Bitte überprüfen Sie Ihre Filtereinstellungen oder versuchen Sie es später erneut."
            />
        );
    }
