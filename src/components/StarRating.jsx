        ...
        <div className="flex">
            {[1,2,3,4,5].map(star => (
                <Star 
                    ...
                    onClick={() => {
                        // Hier kannst du später das Rating an das Backend senden oder im State speichern
                        console.log('Neue Bewertung:', star);
                    }}
                    disabled={false} // Setze dies auf true, wenn die Bewertung deaktiviert sein soll
                />
            ))}
        </div>
     );
